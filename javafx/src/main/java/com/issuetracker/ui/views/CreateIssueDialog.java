...
import com.issuetracker.ui.controllers.CreateIssueDialogController;
import com.issuetracker.ui.domain.Issue;
...
public class CreateIssueDialog {
    ...
    public void show(){
        ViewLoader.LoadedView<CreateIssueDialogController> loaded=
            ViewLoader.load("/com/issuetracker/ui/fxml/create-issue-dialog.fxml");
