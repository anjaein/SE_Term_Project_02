...
| 이름 | 사진                                                                                                                    | 담당 |
|------|-----------------------------------------------------------------------------------------------------------------------| ------|
| 김태우 | <img width="100" alt="Image" src="https://github.com/user-attachments/assets/5d5c615f-886a-4793-8b9a-163397570d7c" /> |  <ul><li>프로젝트 기초 구조 설계</li><li>Comment Controller, Service 등 관련 코드 구현</li><li>Swing UI 구현</li></ul>  |
| 박신빈 | <img width="100" alt="박신빈" src="https://github.com/user-attachments/assets/96143f00-2162-496e-bd61-bea93a050af1" />   | <ul><li>프로젝트 기초 구조 설계</li><li>Issue Entity, IssueStatistics, Project 등 관련 코드 구현</li><li>Validator, Response, SessionManager, Main 구현</li></ul> |
| 안재인 | <img width="460" height="460" alt="103022804" src="https://github.com/user-attachments/assets/38369a28-0de7-49a0-87b6-4cf48daecb28" /> | <ul><li>프로젝트 기초 구조 설계</li><li>Issue, Project 등 관련 코드 구현</li><li>javafx UI 구현</li></ul> |
